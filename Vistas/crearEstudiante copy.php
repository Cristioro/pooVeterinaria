            ...
            <div class="form-group">
                ...
                <label for="txtRazon" class="control-label col-md-3">Razon:</label>
                    <select class="form-select" name="txtRazon" required>
                        ...
                        <option value="Tratamiento de enfermedades">Tratamiento de enfermedades</option>
                        ...
                        <option value="Urgencias veterinarias">Urgencias veterinarias</option>
                        <option value="Control de parásitos">Control de parásitos</option>
                        <option value="Nutrición y dietas especializadas">Nutrición y dietas especializadas</option>
